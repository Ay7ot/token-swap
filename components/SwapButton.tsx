  ...
  return (
    <div className="space-y-2">
      <button 
        ...
        className="w-full py-3 sm:py-4 rounded-xl bg-gradient-to-r from-primary to-secondary hover:shadow-glow disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
      >
      ...
      {error && (
        <div className="text-xs sm:text-sm text-red-400 text-center p-2 sm:p-3 rounded-xl bg-red-500/5 border border-red-500/10">
